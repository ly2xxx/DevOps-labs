...
| ☸️ **K3s & Kubernetes** | [K3s & Kubernetes Cheat Sheet](k3s-agent-team/cheatsheet.md) | Operations guide for K3s local cluster setup, kubectl workload management, and debugging. | `kubectl get/describe/logs/top/scale`, pod lifecycle troubleshooting, network policies & quotas, custom agent controller API requests. |
